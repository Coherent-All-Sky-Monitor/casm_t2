...
Install + start (corr1):
    ...
    cp ~/software/dev/casm_t2/deploy/systemd/{t2-source-watch,t2d}.service ~/.config/systemd/user/
    cp ~/software/dev/casm_t3/deploy/systemd/{t3-dump-plotter-corr1,t3-collect}.service ~/.config/systemd/user/
    systemctl --user daemon-reload
    systemctl --user enable --now t2-source-watch t2d t3-dump-plotter-corr1 t3-collect
